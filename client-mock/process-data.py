...
def main():
    ...
    args.registry_id="junction-registry"
    args.cloud_region="europe-west1"
    args.project_id="junctionx-257019"
    ...
    with open('data.csv',"r") as source:
        for r in source:
            ...
            resp = publish_message(
                ...
                args.cloud_region, args.registry_id, devicename, jwt_token)
...
def register(args):
    with open('data.csv',"r") as source:
        ...
        print resultSet
        for i in resultSet:
            cmd = "gcloud beta iot devices create " +  i + "\
